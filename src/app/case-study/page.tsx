          ...
          <div className="relative flex items-center justify-center gap-5  h-full ">
            <div className="flex items-center w-full pt-12 md:pt-0">
              <div>
                <MainHeading
                  bgHeading="My Work"
                  smallHeading="My Success Story"
                  mainHeadng={{ sliceOne: "Case Studies ", sliceTwo: "" }}
                />
      ...
      <section className="py-16">
        <div className="container mx-auto px-6 lg:max-w-[1170px]">
          <h2 className="relative text-3xl lg:text-5xl font-bold mb-12 m-auto border-b border-secondary-light w-fit pb-6 before:absolute before:h-[1px] before:w-[120px] before:bottom-0 before:bg-primary before:left-1/2 before:-translate-x-1/2">
            Work{" "}
            <span className="text-3xl lg:text-5xl text-primary">Showcase</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
            {CasesStudy.map((project) => {
              return (
                <CaseStudyCard
                  id={project.id}
                  key={project.id}
        ...
        <div className="container mx-auto px-6 lg:max-w-[1170px]">
          <div className="flex flex-col items-center mb-12">
            ...
            <p className="text-center  text-lg">
              Dr. Ahmed Habib Delivers Results in E-Learning and Jobs Platforms
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-8 px-4">
            <div className="relative p-6">
              ...
              <span className="absolute -top-5 -left-8 w-[150px] h-[150px] bg-gradient-to-t from-20% from-[#1e2229] to-[#ffb300f1] rounded-full opacity-10"></span>
              <div className="relative">
                <h1 className="text-3xl text-primary font-bold">
                  Scalable Infrastructure
                </h1>
                <p className="text-lg ">
                  Building robust systems to support growth and handle
                  increasing demand.
                </p>
              </div>
            </div>
            <div className="relative p-6">
              ...
              <div className="relative">
                ...
                <p className="text-lg ">
                  Prioritizing user experience to drive engagement and
                  retention.
                </p>
              </div>
            </div>
            <div className="relative p-6">
              ...
              <div className="relative">
                ...
                <p className="text-lg ">
                  Implementing verification and security measures to build user
                  confidence
                </p>
              </div>
            </div>
            <div className="relative p-6">
              ...
              <div className="relative">
                ...
                <p className="text-lg ">
                  Introducing new revenue models to ensure financial
                  sustainability.
                </p>
              </div>
            </div>
            <div className="relative p-6">
              ...
              <div className="relative">
                ...
                <p className="text-lg ">
                  Leveraging advanced technologies to deliver personalized and
                  efficient services.
                </p>
              </div>
            </div>
          ...
          <div className="relative flex flex-col items-center py-16">
            ...
            <p className="text-lg max-w-[600px] text-center">
              ...
              SMEs achieve remarkable growth and operational excellence. Whether
              you're looking to scale your business, optimize operations, or
              embark on a digital transformation journey, Dr. Habib can help you
              achieve your goals
            </p>
          </div>
        </div>
      ...
      <section className="relative pb-16">
        ...
        <div className="container mx-auto px-6 lg:max-w-[1170px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-8 ">
            <div className="flex flex-col items-center border rounded-md p-4 gap-4">
              <Waypoints size={40} />
              <h2 className="text-xl font-bold">Tailored Strategies</h2>
              <p className="text-lg text-center">
                Custom solutions designed to address the unique challenges of
                each business
              </p>
            </div>
            <div className="flex flex-col items-center border rounded-md p-4 gap-4">
              <Settings size={40} />
              <h2 className="text-xl font-bold">Proven Methodologies</h2>
              <p className="text-lg text-center">
                Use of industry-leading frameworks and tools to ensure success.
              </p>
            </div>
            <div className="flex flex-col items-center border rounded-md p-4 gap-4">
              <Handshake size={40} />
              <h2 className="text-xl font-bold">End-to-End Support</h2>
              <p className="text-lg text-center">
                From strategy development to execution and monitoring.
              </p>
            </div>
            <div className="flex flex-col items-center border rounded-md p-4 gap-4">
              <Database size={40} />
              <h2 className="text-xl font-bold">Data-Driven Approach</h2>
              <p className="text-lg text-center">
                Leveraging analytics to make informed decisions and measure
                impact.
              </p>
            </div>
            <div className="flex flex-col items-center border rounded-md p-4 gap-4">
              <Recycle size={40} />
              <h2 className="text-xl font-bold">Focus on Sustainability</h2>
              <p className="text-lg text-center">
                Ensuring that growth is sustainable and aligned with long-term
                business goals.
              </p>
            </div>
          </div>
